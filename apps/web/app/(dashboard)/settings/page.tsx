    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Commonly accessed settings</CardDescription>
        </CardHeader>
                ...
                <div className="flex-1">
                  ...
                  <ul className="mt-3 space-y-1">
                    {category.items.map((item) => (
                      <li key={item} className="text-sm text-gray-600 hover:text-blue-600">
                        {item}
                      </li>
                    ))}
                  </ul>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-lg border border-red-200 bg-red-50">
            <div>
              ...
              <p className="text-sm text-gray-500">Permanently remove all your data from the system</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-red-200 bg-red-50">
            <div>
              ...
              <p className="text-sm text-gray-500">Permanently close your account and delete all data</p>
            </div>
