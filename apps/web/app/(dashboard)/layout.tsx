...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          >
            ...
            {!sidebarCollapsed && (
              <>
                ...
                <kbd className="hidden lg:inline-flex h-5 items-center gap-1 rounded bg-white/10 px-1.5 text-[10px] font-medium">
      ...
      >
        {/* Top Header */}
        <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b bg-white/80 backdrop-blur-xl px-6 shadow-sm">
      ...
      {aiPanelOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-2xl mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b bg-gradient-to-r from-violet-600 to-purple-600 text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Ask anything about your business</p>
                </div>
              </div>
              <button 
                onClick={() => setAiPanelOpen(false)}
            ...
            <div className="h-96 overflow-y-auto p-6 space-y-4 bg-gray-50">
              ...
              <div className="flex gap-3">
                ...
                <div className="bg-white rounded-2xl rounded-tl-md px-4 py-3 shadow-sm border max-w-md">
              ...
              <div className="flex flex-wrap gap-2 pl-11">
                <button className="px-3 py-1.5 text-sm bg-white border rounded-full hover:bg-gray-50 hover:border-violet-300 transition-colors">
            ...
            <div className="p-4 border-t bg-white">
              ...
              <p className="text-xs text-gray-400 mt-2 text-center">
                Kyte AI can access your business data to provide personalized insights
              </p>
            </div>
          </div>
        </div>
